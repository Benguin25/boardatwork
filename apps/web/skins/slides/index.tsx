...
const ROOT_STYLE: React.CSSProperties = {
  ...
  // white text, short of WCAG AA's 4.5:1 for the primary Actions button
  // (which renders white text on this token) — darkened to #1967d2
  // (5.37:1) to fix that (CLAUDE.md: "Accessibility is not optional"),
  // without changing the Google-blue identity of the token.
